package cn.sn.zwcx.material.widgets;
...
import cn.sn.zwcx.material.R;


/**
 * Created on 2017/7/31 16:15
...
public class PowerfulEditText extends AppCompatEditText {
    ...
    public PowerfulEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        eyeCloseResourseId = ta.getResourceId(R.styleable.PowerfulEditText_eyeClose, R.drawable.hidden_icon_selector);
        eyeOpenResourseId = ta.getResourceId(R.styleable.PowerfulEditText_eyeOpen, R.drawable.show_icon_selector);
        ...
        if (mRightDrawable == null) {
            ...
            if (funcType == TYPE_CAN_CLEAR) {
             ...
             //   mRightDrawable = getResources().getDrawable(R.drawable.delete_selector);
                mRightDrawable = ContextCompat.getDrawable(context,R.drawable.delete_icon_selector);
             ...
             //   mEyeOpenDrawable = getResources().getDrawable(eyeOpenResourseId);
                mRightDrawable = ContextCompat.getDrawable(context,eyeCloseResourseId);
                mEyeOpenDrawable = ContextCompat.getDrawable(context,eyeCloseResourseId);
            }
        }

        if (leftDrawable != null) {
            leftWidth = ta.getDimensionPixelOffset(R.styleable.PowerfulEditText_leftDrawableWidthEdit,leftDrawable.getIntrinsicWidth());
            leftHeight = ta.getDimensionPixelOffset(R.styleable.PowerfulEditText_leftDrawableHeightEdit,leftDrawable.getIntrinsicHeight());
            leftDrawable.setBounds(0, 0, leftWidth, leftHeight);
        }

        if (mRightDrawable != null) {
            rightWidth = ta.getDimensionPixelOffset(R.styleable.PowerfulEditText_rightDrawableWidthEdit,mRightDrawable.getIntrinsicWidth());
            rightHeight = ta.getDimensionPixelOffset(R.styleable.PowerfulEditText_rightDrawableWidthEdit,mRightDrawable.getIntrinsicHeight());
