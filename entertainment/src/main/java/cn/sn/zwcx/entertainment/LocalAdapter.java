...
public class LocalAdapter extends BaseAdapter implements Filterable {
	 ...
	 * 
	 * @param context
	 *            The context where the View associated with this UPNPAdapter is
	 *            running
	 * @param data
	...
	/**
	 * This class can be used by external clients of UPNPAdapter to bind values
	 * to views.
	 *
	 * You should use this class to bind values to views that are not directly
	 * supported by UPNPAdapter or to change the way binding occurs for views
	 * supported by UPNPAdapter.
	 *
	...
	public static interface ViewBinder {
		 ...
		 * true. If this method returns false, UPNPAdapter will attempts to
