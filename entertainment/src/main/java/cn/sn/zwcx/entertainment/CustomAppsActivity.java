...
public class CustomAppsActivity extends Activity {
	...
	// public final static String SHORTCUT_PATH = "/data/data/com.canzone.amllauncher/shortcut.cfg";
	public final static String SHORTCUT_PATH = "/data/data/cn.sn.zwcx.entertainment/shotrcut.cfg";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gv = findViewById(R.id.grid_add_apps);
				...
				synchronized (mLock) {
					...
					if (item.get("item_type").equals(R.drawable.item_img_exit)) {
						...
						if (Launcher.current_shortcutHead.equals(HOME_SHORTCUT_HEAD)
								&& homeShortcutCount >= Launcher.HOME_SHORTCUT_COUNT) {
							Toast.makeText(mContext, mContext.getResources().getString(R.string.str_nospace),
						...
						((Map<String, Object>) parent.getItemAtPosition(pos)).put("item_sel",
		...
		mContext = this;
		img_screen_shot = findViewById(R.id.img_screenshot);
		img_screen_shot_keep = findViewById(R.id.img_screenshot_keep);
		img_dim = findViewById(R.id.img_dim);
	...
	private void displayView() {
		homeShortcutCount = 0;
		LocalAdapter ad = new LocalAdapter(CustomAppsActivity.this, loadApplications(), R.layout.add_apps_grid_item,
