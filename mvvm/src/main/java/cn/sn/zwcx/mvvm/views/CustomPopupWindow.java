...
public abstract class CustomPopupWindow extends PopupWindow {
    ...
    public CustomPopupWindow(Context context, int layoutId, int width, int height) {
        mContext = context;
    ...
    protected void initWindow() {
        mInstance.setAnimationStyle(R.style.MePopupWindowAnimStyle);
